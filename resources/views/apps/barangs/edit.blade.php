...
<main id="main" class="main">
    <div class="row">
        <div class="col-lg-12">
            <div class="card p-2">
                <div class="card-body">
                    <h4 class="card-title mr-4 pr-4">Edit Data Barang</h4>
                    <form action="{{ route('barang-edit-submit', $dataEdit->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-7">
                                <select class="form-select @error('jenis_id') is-invalid @enderror" name="jenis_id" id="jenis_id"
                                    ...
                                    @foreach ($jenis_barang as $jenis)
                                        @if (old('jenis_id', $dataEdit->jenis_id) == $jenis->id)
                            ...
                            <div class="col-7">
                                <select class="form-select @error('uraian_id') is-invalid @enderror" name="uraian_id" id="uraian_id"
                                    ...
                                    @foreach ($uraian_barang as $uraian)
                                        @if (old('uraian_id', $dataEdit->uraian_id) == $uraian->id)
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="kode_barang" name="kode_barang"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->kode_barang ? $dataEdit->kode_barang : old('kode_barang') }}" required>
                                @error('kode_barang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="nup" name="nup"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->nup ? $dataEdit->nup : old('nup') }}" required>
                                @error('nup')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="nama" name="nama"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->nama ? $dataEdit->nama : old('nama') }}" required>
                                @error('nama')
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="tahun" name="tahun"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->tahun ? $dataEdit->tahun : old('tahun') }}" required>
                                @error('tahun')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="kuantitas" name="kuantitas"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->kuantitas ? $dataEdit->kuantitas : old('kuantitas') }}" required>
                                @error('kuantitas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="lokasi" name="lokasi"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->lokasi ? $dataEdit->lokasi : old('lokasi') }}" required>
                                @error('lokasi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="nilai" name="nilai"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->nilai ? formatRupiahAngka($dataEdit->nilai) : formatRupiahAngka(old('nilai')) }}" required>
                                @error('nilai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            ...
                            <div class="col-7">
                                <input type="text" id="keterangan" name="keterangan"
                                    ...
                                    autocomplete="off" value="{{ $dataEdit->keterangan ? $dataEdit->keterangan : old('keterangan') }}" required>
                                @error('keterangan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
